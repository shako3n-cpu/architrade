 ...
 *   3. Fill `name`, `tagline` and `story` for ALL THREE languages.
...
export const collections: Collection[] = [
  {
    ...
    tagline: {
      ...
      ru: 'Светлый дуб, шерсть и лён — пространство, оставленное свету.',
    },
    story: {
      ...
      ru: 'Arch-Nordic начался с простого вопроса: сколько можно убрать, прежде чем предмет перестанет быть тёплым. Линии прямые, соединения оставлены на виду, поверхности покрыты маслом, а не лаком. Светлый дуб и неокрашенная шерсть медленно темнеют с годами, и комната становится не старее, а обжитее.',
    },
...

  {
    ...
    tagline: {
      ...
      ru: 'Орех, кожа и камень — материалы, которые не скрывают возраст.',
    },
    story: {
      ...
      ru: 'Terra — тёплая коллекция. Массив ореха темнеет, анилиновая кожа набирает патину, а травертин сохраняет открытые поры, данные ему природой. Ничто не отполировано настолько, чтобы отпечаток пальца читался как изъян. Она сделана для домов, где мебелью пользуются каждый день, а не просто хранят её.',
    },
...

  {
    ...
    tagline: {
      ...
      ru: 'Чернёная сталь, копчёный дуб и бархат.',
    },
    story: {
      ...
      ru: 'Atelier — самая городская из трёх коллекций, придуманная для квартир с высокими потолками, где свет приходит только с одной стороны. Каркасы из чернёной стали, поверхности из копчёного дуба, а обивка — бархат, который ловит свет по-разному в разные часы дня. Тёмная палитра не уменьшает комнату, а даёт её глубине место.',
    },
