...
export function CategoryRow({
  ...
  return (
    <div
      ...
      // The indent is inline because depth is data; a utility class would need
      // one variant per level. The step itself is a token, so it can shrink on
      // a phone without this having to know it did.
      style={{ paddingLeft: `calc(1rem + ${node.depth} * var(--at-tree-step))` }}
    >
